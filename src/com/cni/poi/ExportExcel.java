...
public class ExportExcel {
	...
	public void setConditionalFormatting(XSSFSheet sheet ){
		
//		XSSFWorkbook workbook = new XSSFWorkbook(); // or new XSSFWorkbook();
//	    XSSFSheet sheet = workbook.createSheet();
	
	    SheetConditionalFormatting sheetCF = sheet.getSheetConditionalFormatting();
	
	    ConditionalFormattingRule rule1 = sheetCF.createConditionalFormattingRule(ComparisonOperator.BETWEEN, "0.0001", "0.8");
...
//	    bordFmt.setBorderRight(BorderFormatting.BORDER_DOTTED);
	    ...
	    org.apache.poi.ss.usermodel.PatternFormatting patternFmt = rule1.createPatternFormatting();
	    patternFmt.setFillBackgroundColor(IndexedColors.RED.index);
	
//	    ConditionalFormattingRule rule2 = sheetCF.createConditionalFormattingRule(ComparisonOperator.BETWEEN, "0.0001", "0.8");
